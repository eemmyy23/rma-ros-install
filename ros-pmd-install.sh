...
sudo apt-get install ros-electric-plc16
...
rosws set ${rosWorkspaceDir}/pmd_camcube_3_ros_pkg --svn http://rma-ros-install.googlecode.com/svn/trunk/packages/pmd_camcube_3_ros_pkg -y
rosws update pmd_camcube_3_ros_pkg
source ${rosWorkspaceDir}/setup.bash
rosdep install pmd_camcube_3_ros_pkg 
echo "export PMDDIR=${rosWorkspaceDir}/pmd_camcube_3_ros_pkg/PMDSDK2" >> $HOME/.bashrc
